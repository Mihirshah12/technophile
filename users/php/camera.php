      ...
      <div class="container">
        <div class="row bar">
          <div class="col-md-3">
              ...
              <div class="panel-body">
                <ul class="nav nav-pills flex-column text-sm category-menu">
                  ...
                  ?></a>
                   ...
                   <li class="nav-item"><a href="camera.php" class="nav-link active d-flex align-items-center justify-content-between"><span>Camera's </span><?php
                      include 'databaseconnection.php';
            ...
            <div class="col-md-9">
              <p class="text-muted lead">For all those photogenic geeks out there show your skills!</p>
              <div class="row products products-big">


                      <?php
                        include 'databaseconnection.php';
                        $sql="Select Pid,Name,Image,Perday from camera";
                        $result=mysqli_query($conn,$sql);

                        while($row=mysqli_fetch_assoc($result)){
                        echo "<div class='col-lg-4 col-md-6'>
                                  <div class='product'>
                                            <div class='image'><a href='display.php?Pid=".$row['Pid']."&test=6'><img src='".$row['Image']."' alt='Cannot display image' class='img-fluid image1'></a></div>

                                          <h3 class='h5'><a href='display.php?Pid=".$row['Pid']."&test=6'>'".$row["Name"]."'</a></h3>
