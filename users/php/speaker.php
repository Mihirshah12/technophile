      ...
      <div id="content">
        <div class="container">
          <div class="row bar">
              ...
              <div class="panel panel-default sidebar-menu">
                ...
                <div class="panel-body">
                  <ul class="nav nav-pills flex-column text-sm category-menu">
                    ...
                    <li class="nav-item"><a href="speaker.php" class="nav-link active d-flex align-items-center justify-content-between"><span>Speakers </span><?php
                        include 'databaseconnection.php';
            ...
            <div class="col-md-9">
              <p class="text-muted lead">Indulge into divine music and have a look at our amazing speakers!</p>
              <div class="row products products-big">


                      <?php
                        include 'databaseconnection.php';
                        $sql="Select Pid,Name,Image,Perday from speaker";
                        $result=mysqli_query($conn,$sql);
                        ...
                        echo "<div class='col-lg-4 col-md-6'>
                                  <div class='product'>
                                            <div class='image'><a href='display.php?Pid=".$row['Pid']."&test=2'><img src='".$row['Image']."' alt='Cannot display image' class='img-fluid image1'></a></div>

                                          <h3 class='h5'><a href='display.php?Pid=".$row['Pid']."&test=2'>'".$row["Name"]."'</a></h3>
