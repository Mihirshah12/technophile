      ...
      <div id="content">
        <div class="container">
          <div class="row bar">
              ...
              <div class="panel panel-default sidebar-menu">
                ...
                <div class="panel-body">
                  <ul class="nav nav-pills flex-column text-sm category-menu">
                    ...
                    <li class="nav-item"><a href="board.php" class="nav-link active d-flex align-items-center justify-content-between"><span>Board Games  </span><?php
                        include 'databaseconnection.php';
            ...
            <div class="col-md-9">
              <p class="text-muted lead">Never too old to play board games eh!</p>
              <div class="row products products-big">


                      <?php
                        include 'databaseconnection.php';
                        $sql="Select Pid,Name,Image,Perday from boardgames";
                        $result=mysqli_query($conn,$sql);
