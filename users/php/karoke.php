      ...
      <div class="container">
        <div class="row bar">
          <div class="col-md-3">
            ...
            <div class="panel panel-default sidebar-menu">
              ...
              <div class="panel-body">
                <ul class="nav nav-pills flex-column text-sm category-menu">
                  <li class="nav-item"><a href="homepage.php" class="nav-link d-flex align-items-center justify-content-between"><span>Best Sellers </span><?php
                  ...
                  <li class="nav-item"><a href="karoke.php" class="nav-link active d-flex align-items-center justify-content-between"><span>Karaoke and remote controls </span><?php
                      include 'databaseconnection.php';
            ...
            <div class="col-md-9">
              <p class="text-muted lead">For all those music geeks out there show your skills!</p>
              <div class="row products products-big">


                      <?php
                        include 'databaseconnection.php';
                        $sql="Select Pid,Name,Image,Perday from karoke";
                        $result=mysqli_query($conn,$sql);

                        while($row=mysqli_fetch_assoc($result)){
                        echo "<div class='col-lg-4 col-md-6'>
                                  <div class='product'>
                                            <div class='image'><a href='display.php?Pid=".$row['Pid']."&test=5'><img src='".$row['Image']."' alt='Cannot display image' class='img-fluid image1'></a></div>

                                          <h3 class='h5'><a href='display.php?Pid=".$row['Pid']."&test=5'>'".$row["Name"]."'</a></h3>
